...
manage_urlpatterns = patterns('courses.views',
                              url(r'^$', "manage_course_view", name='manage_course'),
                              url(r'^week/$', "manage_week_view", name='manage_week'),
                              url(r'^week/(?P<week_number>\d+)/$', "manage_lecture_view",
                                  name='manage_lecture'),
)

urlpatterns = patterns('courses.views',
                       url(r'^new$', "create_course_view", name='new_course'),
                       url(r'^(?P<course_id>\d+)/$', "course_view", name='course_page'),
                       url(r'^(?P<course_id>\d+)/lectures/$', "lecture_list_view", name='course_lectures'),
